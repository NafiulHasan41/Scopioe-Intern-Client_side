...
const Top_navbar = () => {
    ...
    return (
        <div className="h-[60px] md:h-[88px] max-h-[88px] w-full border-b-[1px] border-[#E7E7E7] flex justify-between items-center">
            ...
            {isNotMobile ? (
                <div className="flex items-center pr-[30px] py-[24px] h-[40px]">
                    ...
                    <div className="h-[40px] flex items-center ml-5 pl-5 border-l-[1px] border-[#E7E7E7]">
                        {user ? (
                            <button onClick={handleLogOut} className="text-[#F15E4A] text-[15px] flex items-center gap-[10px]">
                                Logout
                                <div className="w-[40px] bg-[#FFECEA] h-[40px] rounded-[40px] flex items-center justify-center">
                                    <IoEnterOutline className="w-[20px] h-[20px]" />
                                </div>
                            </button>
                        ) : (
                            <Link to="/login">
                                <button className="text-green-500 flex items-center gap-[10px]">
                                    Login
                                    <div className="w-[40px] bg-green-100 h-[40px] rounded-[40px] flex items-center justify-center">
                                        <IoEnterOutline className="w-[20px] h-[20px]" />
                                    </div>
                                </button>
                            </Link>
