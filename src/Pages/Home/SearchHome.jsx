    ...
    return (
        <div className=" flex flex-col justify-between lg:flex-row  bg-[#FFFFFF] w-full p-2 lg:p-5 lg:h-[220px] rounded-[10px] ">
            ...
            <div className=" ">
              ...
              <img className=" absolute top-[6px] right-[40px]" src="https://i.ibb.co/fFzWkKC/Vector.png" alt="" />
             </div>
            ...
            <div className=" hidden md:block md:relative mr-[30px] ">
              <img src="https://i.ibb.co/fNDxf2B/Group-1000001700.png" alt="" />
              <img className=" absolute top-[35px] right-[140px]" src="https://i.ibb.co/fFzWkKC/Vector.png" alt="" />
            </div>
